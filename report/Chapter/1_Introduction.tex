...
\begin{itemize}
    ...
    \item **Chapter 3: THEORETICAL BACKGROUND AND TECHNOLOGIES** presents the fundamental concepts of Knowledge Graphs, Neo4j, Vector RAG, GraphRAG, the ReAct reasoning paradigm, dialog state orchestration, and justifies the selection of local open-source LLMs and FastAPI.
