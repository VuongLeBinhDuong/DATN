...
\texttt{\textbackslash begin\{itemize\}}\\
 \texttt{\textbackslash item} Nội dung thứ nhất được viết ở đây.\\
\texttt{\textbackslash item} Nội dung thứ hai được viết ở đây.\\
...
\end{itemize}
Chú ý các nội dung trình bày trong cả hai môi trường liệt kê theo sau lệnh \texttt{\textbackslash item}. Ngoài ra LaTeX còn cung cấp một số kiểu liệt kê khác, sinh viên có thể tham khảo tại \url{https://www.overleaf.com/learn/latex/Lists}
