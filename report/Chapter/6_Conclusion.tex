...
\begin{itemize}
    ...
    \item \textbf{Graph-First Hybrid Retrieval with Clinical NER}: A dual-layer retrieval engine was implemented, routing queries first to the Custom KG. The engine leverages a parallel lightweight SLM (\texttt{qwen2.5:1.5b-instruct}) for Clinical NER extraction to execute targeted Cypher Path Queries linking concepts, falling back to standard k-hop expansions or Microsoft GraphRAG community summaries as needed to optimize precision.
