...
\captionsetup{justification=centering,singlelinecheck=false,width=0.95\textwidth}
...
\usepackage{setspace}
% \usepackage{parskip} % Avoid global paragraph layout changes in thesis format
...
% listings package is loaded above for source-code formatting.
...
\def \TITLE{Xây dựng hệ thống tư vấn và tra cứu y tế kết hợp AI Agents và RAG (Retrieval-Augmented-Generation)}
\def \AUTHOR{Vương Lê Bình Dương}
...
\setlist[itemize]{leftmargin=*,labelsep=0.5em,itemsep=2pt,topsep=3pt}
\setlist[enumerate]{leftmargin=*,labelsep=0.5em,itemsep=2pt,topsep=3pt}
...
% Improve justified text and safe line breaks for long identifiers, code, and links.
...
\textbf{Abbreviation} & \textbf{Full Expression} \\ \hline
...
%\mainmatter
\titleformat{\chapter}[hang]{\filcenter\bfseries}{ \thechapter.\ }{0pt}{}[]
\titlespacing*{\chapter}{0pt}{-20pt}{20pt}
...
\chapter{CORE SYSTEM PROMPTS}
\subfile{Chapter/Appendix_C}

\chapter{DEPLOYMENT GUIDE}
\subfile{Chapter/Appendix_D}

\chapter{DATABASE DICTIONARY}
\subfile{Chapter/Appendix_E}

\chapter{CORE CODE SNIPPETS}
\subfile{Chapter/Appendix_F}
\end{document}
